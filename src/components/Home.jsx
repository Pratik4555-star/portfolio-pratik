    ...
    <>
      <div className='overflow-x-hidden'>
        ...
        <div className="px-10 py-5 w-full h-1/2 ">
          ...
          <p className="py-4 px-10 mt-3 text-gray-500 font-inner tracking-wide text-justify text-2xl">Welcome to Pratik’s Portfolio, where technology and innovation take center stage! I’m Pratik, a fresher with a strong foundation in JavaScript, HTML, CSS, MongoDB, and Express.
          ...
          <p className="py-3 px-10  font-inner text-gray-500 font-semibold tracking-wide text-justify text-2xl">Specializing in:</p>
          <ul className="list-disc px-16 text-gray-500 font-inner text-2xl tracking-wide mb-4">
          ...
          <p className="py-3 px-10 text-gray-500 font-inner tracking-wide text-justify text-2xl">
