  ...
  return (
    <>
      <div className='overflow-x-hidden'>
        {/* hero page */}
        <div id="info" className="flex w-full h-1/2 md:h-screen flex-col md:flex-row justify-between items-center">
          ...
          <div id='im' className="title flex justify-center mt-6 md:mt-10 w-full md:w-1/2">
            <img
              src={image}
              alt="Image"
              className="w-1/2 h-96 md:w-[450px] md:h-[550px] rounded-t-[100px] md:rounded-t-[150px] object-cover grayscale hover:grayscale-0 duration-300"
            />
          </div>
        </div>
        ...
        <div className="px-10 py-5 w-full h-1/2">
          <h1 className="text-center mt-14 md:mt-0 text-2xl md:text-3xl font-semibold font-inner">ABOUT</h1>
          <p className="py-4 px-10 mt-3 text-gray-500 font-inner text-xl tracking-wide text-justify md:text-2xl">
          ...
          <p className="py-3 px-10 font-inner text-gray-500 text-xl font-semibold tracking-wide text-justify md:text-2xl">Specializing in:</p>
          <ul className="list-disc px-16 text-gray-500 text-xl font-inner md:text-2xl tracking-wide mb-4">
          ...
          <p className="py-3 px-10 text-gray-500 font-inner text-xl tracking-wide text-justify md:text-2xl">
        ...
        {/* Contact Section */}
        <div className="mt-56 relative w-full  h-1/2 mb-20 flex ">
          <h1 className="font-inner text-[30px] px-10 md:px-16 transform-cpu text-center text-gray-400 font-bold md:text-6xl text-4xl">
